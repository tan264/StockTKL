...
class OrderHistoryController extends GetxController {
  ...
  final String token =
      'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJoZHRydW5nIiwiaWF0IjoxNzAxMjA1MTc4LCJleHAiOjE3MDEyOTE1Nzh9.lF88UJfdWKKTpP0RzgjWhfyhQEMLnn0ffOYj84vMFI8';
  ...
  void fetchOrderHistory() async {
    isLoading(true);
    try {
      var fetchedOrders = await apiService.getOrderHistory(_authService.token!);
